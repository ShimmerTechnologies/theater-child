...
function theater_register_css_styles() {
	...
	if (!is_admin()) {
		...
		$upload_dir = fn_get_upload_dir_var();
...
add_action('wp_enqueue_scripts', 'theater_register_css_styles');
...
function theater_register_js_scripts() {
	...
	$cmsmasters_localize_array = array( 
		...
		'project_puzzle_proportion' => 			theater_project_puzzle_proportion(), 

		'gmap_api_key' => 						$cmsmasters_option['theater' . '_gmap_api_key'], 

		'gmap_api_key_notice' => 				esc_html__('Please add your Google Maps API key', 'theater'), 

		'gmap_api_key_notice_link' => 			esc_html__('read more how', 'theater'), 

		'primary_color' => 						$cmsmasters_option['theater' . '_default_link'], 

		'ilightbox_skin' => 					$cmsmasters_option['theater' . '_ilightbox_skin'], 

		'ilightbox_path' => 					$cmsmasters_option['theater' . '_ilightbox_path'], 

		'ilightbox_infinite' => 				$cmsmasters_option['theater' . '_ilightbox_infinite'], 

		'ilightbox_aspect_ratio' => 			$cmsmasters_option['theater' . '_ilightbox_aspect_ratio'], 

		'ilightbox_mobile_optimizer' => 		$cmsmasters_option['theater' . '_ilightbox_mobile_optimizer'], 

		'ilightbox_max_scale' => 				$cmsmasters_option['theater' . '_ilightbox_max_scale'], 

		'ilightbox_min_scale' => 				$cmsmasters_option['theater' . '_ilightbox_min_scale'], 

		'ilightbox_inner_toolbar' => 			$cmsmasters_option['theater' . '_ilightbox_inner_toolbar'], 

		'ilightbox_smart_recognition' => 		$cmsmasters_option['theater' . '_ilightbox_smart_recognition'], 

		'ilightbox_fullscreen_one_slide' => 	$cmsmasters_option['theater' . '_ilightbox_fullscreen_one_slide'], 

		'ilightbox_fullscreen_viewport' => 		$cmsmasters_option['theater' . '_ilightbox_fullscreen_viewport'], 

		'ilightbox_controls_toolbar' => 		$cmsmasters_option['theater' . '_ilightbox_controls_toolbar'], 

		'ilightbox_controls_arrows' => 			$cmsmasters_option['theater' . '_ilightbox_controls_arrows'], 

		'ilightbox_controls_fullscreen' => 		$cmsmasters_option['theater' . '_ilightbox_controls_fullscreen'], 

		'ilightbox_controls_thumbnail' => 		$cmsmasters_option['theater' . '_ilightbox_controls_thumbnail'], 

		'ilightbox_controls_keyboard' => 		$cmsmasters_option['theater' . '_ilightbox_controls_keyboard'], 

		'ilightbox_controls_mousewheel' => 		$cmsmasters_option['theater' . '_ilightbox_controls_mousewheel'], 

		'ilightbox_controls_swipe' => 			$cmsmasters_option['theater' . '_ilightbox_controls_swipe'], 

		'ilightbox_controls_slideshow' => 		$cmsmasters_option['theater' . '_ilightbox_controls_slideshow'], 

		'ilightbox_close_text' => 				esc_html__('Close', 'theater'), 

		'ilightbox_enter_fullscreen_text' => 	esc_html__('Enter Fullscreen (Shift+Enter)', 'theater'), 

		'ilightbox_exit_fullscreen_text' => 	esc_html__('Exit Fullscreen (Shift+Enter)', 'theater'), 

		'ilightbox_slideshow_text' => 			esc_html__('Slideshow', 'theater'), 

		'ilightbox_next_text' => 				esc_html__('Next', 'theater'), 

		'ilightbox_previous_text' => 			esc_html__('Previous', 'theater'), 

		'ilightbox_load_image_error' => 		esc_html__('An error occurred when trying to load photo.', 'theater'), 

		'ilightbox_load_contents_error' => 		esc_html__('An error occurred when trying to load contents.', 'theater'), 

		'ilightbox_missing_plugin_error' => 	esc_html__("The content your are attempting to view requires the <a href='{pluginspage}' target='_blank'>{type} plugin<\/a>.", 'theater') 
	...
	wp_enqueue_script('theater-script', get_template_directory_uri() . '/js/jquery.script.js', array('jquery'), '1.0.0', true);

	

	wp_localize_script('theater-script', 'cmsmasters_script', $cmsmasters_localize_array);

	

	wp_enqueue_script('theater-theme-script', get_template_directory_uri() . '/theme-framework/theme-style' . CMSMASTERS_THEME_STYLE . '/js/jquery.theme-script.js', array('jquery', 'theater-script'), '1.0.0', true);
	...
	if ( 
		...
		isset($cmsmasters_option['theater' . '_gmap_api_key']) && 

		$cmsmasters_option['theater' . '_gmap_api_key'] != '' 

	) {

		wp_enqueue_script('gMapAPI', '//maps.googleapis.com/maps/api/js?key=' . $cmsmasters_option['theater' . '_gmap_api_key'], array('jquery'), '1.0.0', true);
	...
	$cmsmasters_custom_js = stripslashes($cmsmasters_option['theater' . '_custom_js']);

	

	wp_add_inline_script('theater-script', $cmsmasters_custom_js);
...
add_action('wp_enqueue_scripts', 'theater_register_js_scripts');
...
if (!function_exists('theater_theme_google_fonts_generate')) {



function theater_theme_google_fonts_generate() {
	...
	foreach (cmsmasters_google_fonts_list() as $key => $value) {
		...
		if ( 
			...
			(isset($cmsmasters_option['theater' . '_content_font_google_font']) && $key == $cmsmasters_option['theater' . '_content_font_google_font'] && $key != '') || 

			(isset($cmsmasters_option['theater' . '_link_font_google_font']) && $key == $cmsmasters_option['theater' . '_link_font_google_font'] && $key != '') || 

			(isset($cmsmasters_option['theater' . '_nav_title_font_google_font']) && $key == $cmsmasters_option['theater' . '_nav_title_font_google_font'] && $key != '') || 

			(isset($cmsmasters_option['theater' . '_nav_dropdown_font_google_font']) && $key == $cmsmasters_option['theater' . '_nav_dropdown_font_google_font'] && $key != '') || 

			(isset($cmsmasters_option['theater' . '_h1_font_google_font']) && $key == $cmsmasters_option['theater' . '_h1_font_google_font'] && $key != '') || 

			(isset($cmsmasters_option['theater' . '_h2_font_google_font']) && $key == $cmsmasters_option['theater' . '_h2_font_google_font'] && $key != '') || 

			(isset($cmsmasters_option['theater' . '_h3_font_google_font']) && $key == $cmsmasters_option['theater' . '_h3_font_google_font'] && $key != '') || 

			(isset($cmsmasters_option['theater' . '_h4_font_google_font']) && $key == $cmsmasters_option['theater' . '_h4_font_google_font'] && $key != '') || 

			(isset($cmsmasters_option['theater' . '_h5_font_google_font']) && $key == $cmsmasters_option['theater' . '_h5_font_google_font'] && $key != '') || 

			(isset($cmsmasters_option['theater' . '_h6_font_google_font']) && $key == $cmsmasters_option['theater' . '_h6_font_google_font'] && $key != '') || 

			(isset($cmsmasters_option['theater' . '_button_font_google_font']) && $key == $cmsmasters_option['theater' . '_button_font_google_font'] && $key != '') || 

			(isset($cmsmasters_option['theater' . '_small_font_google_font']) && $key == $cmsmasters_option['theater' . '_small_font_google_font'] && $key != '') || 

			(isset($cmsmasters_option['theater' . '_input_font_google_font']) && $key == $cmsmasters_option['theater' . '_input_font_google_font'] && $key != '') || 

			(isset($cmsmasters_option['theater' . '_quote_font_google_font']) && $key == $cmsmasters_option['theater' . '_quote_font_google_font'] && $key != '') 
...
add_action('wp_enqueue_scripts', 'theater_theme_google_fonts_generate');
...
function theater_get_google_font($font) {
...
function theater_the_widgets_init() {
    ...
    register_sidebar(
        ...
        array(
            ...
            'description' => esc_html__('Widgets in this area will be shown in all left and right sidebars till you don\'t use custom sidebar.', 'theater'), 
    ...
    register_sidebar(
        ...
        array(
            ...
            'name' => esc_html__('Bottom Sidebar', 'theater'), 

            'id' => 'sidebar_bottom', 

            'description' => esc_html__('Widgets in this area will be shown at the bottom of middle block below the content and middle sidebar, but above footer.', 'theater'), 
    ...
    register_sidebar(
        ...
        array(
            ...
            'name' => esc_html__('Archive Sidebar', 'theater'), 

            'id' => 'sidebar_archive', 

            'description' => esc_html__('Widgets in this area will be shown in all left and right sidebars on archives pages.', 'theater'), 
    ...
    register_sidebar(
        ...
        array(
            ...
            'name' => esc_html__('Search Sidebar', 'theater'), 

            'id' => 'sidebar_search', 

            'description' => esc_html__('Widgets in this area will be shown in left or right sidebar on search page.', 'theater'), 
	...
	if (isset($cmsmasters_option['theater' . '_sidebar']) && sizeof($cmsmasters_option['theater' . '_sidebar']) > 0) {

		foreach ($cmsmasters_option['theater' . '_sidebar'] as $sidebar) {
			...
			register_sidebar(array( 
				...
				'description' => esc_html__('Custom sidebar created with cmsmasters admin panel.', 'theater'), 
...
add_action('widgets_init', 'theater_the_widgets_init');
...
function theater_page_menu_args($args) {
...
add_filter('wp_page_menu_args', 'theater_page_menu_args');
...
if (function_exists('add_theme_support')) {
	...
	function theater_add_post_type_support_project($post) {
	...
	add_action('load-post.php', 'theater_add_post_type_support_project');

	

	add_action('load-post-new.php', 'theater_add_post_type_support_project');
	...
	add_filter('image_size_names_choose', 'theater_select_image_size');
...
function theater_select_image_size($sizes) {
...
function theater_add_editor_styles() {
...
add_action('init', 'theater_add_editor_styles');
...
function theater_new_excerpt_more($more) {
...
add_filter('excerpt_more', 'theater_new_excerpt_more');
...
function theater_excerpt($length = 55, $show = true) {
...
function theater_post_author_archive($query) {
...
add_action('pre_get_posts', 'theater_post_author_archive');
...
function theater_rowcheck($content) {
...
function theater_generate_front_css() {
	...
	wp_add_inline_style('theater-retina', $shortcodes_css);

}



add_action('wp_enqueue_scripts', 'theater_generate_front_css');
...
function theater_add_global_icons() {
	...
	if ($wp_filesystem) {
		...
		update_option('cmsmasters_' . 'theater' . '_icons', serialize($arr));

		

		update_option('cmsmasters_' . 'theater' . '_icons_custom', serialize($arr_custom));
...
function cmsmasters_composer_icons() {
	...
	if ( 
		...
		$icons = get_option('cmsmasters_' . 'theater' . '_icons');

		

		$icons_custom = get_option('cmsmasters_' . 'theater' . '_icons_custom');
		...
		} elseif (wp_script_is('theater-lightbox-js', 'queue')) {

			wp_add_inline_script('theater-lightbox-js', $out, 'before');
...
function theater_regenerate_styles() {

	$custom_css_fonts = theater_theme_fonts();

	

	$custom_css_colors_primary = theater_theme_colors_primary();

	

	$custom_css_colors_secondary = theater_theme_colors_secondary();
	...
	theater_write_styles($custom_css);
...
function theater_write_styles($styles, $filename = '') {
	...
	$is_dir = theater_create_folder($style_dir);
	...
	if ($is_dir === false) {
		...
		update_option('cmsmasters_style_dir_writable_' . 'theater', 'false');

		

		update_option('cmsmasters_style_exists_' . 'theater', 'false');
	...
	$file = trailingslashit($style_dir) . (($filename != '') ? $filename : 'theater') . '.css';

	

	

	$created = theater_create_file($file, $styles);
	...
	if ($created === true) {
		...
		update_option('cmsmasters_style_dir_writable_' . 'theater', 'true');

		

		update_option('cmsmasters_style_exists_' . 'theater', 'true');
...
function theater_create_folder(&$folder, $addindex = true) {
...
function theater_create_file($file, $content = '', $verifycontent = true) {
...
function cmsmasters_get_tweets($username, $count) {
	...
	$backupName = 'cmsmasters_' . 'theater' . '_tweets_list_backup';
	...
	$connection = new TwitterOAuth( 
		...
		(($cmsmasters_option['theater' . '_api_key'] != '') ? $cmsmasters_option['theater' . '_api_key'] : ''), 

		(($cmsmasters_option['theater' . '_api_secret'] != '') ? $cmsmasters_option['theater' . '_api_secret'] : ''), 

		(($cmsmasters_option['theater' . '_access_token'] != '') ? $cmsmasters_option['theater' . '_access_token'] : ''), 

		(($cmsmasters_option['theater' . '_access_token_secret'] != '') ? $cmsmasters_option['theater' . '_access_token_secret'] : '')
...
function theater_theme_bg_styles() {
	...
	if ($cmsmasters_option['theater' . '_theme_layout'] == 'boxed') {
		...
		if ($cmsmasters_bg_default == 'false') {
			...
			$cmsmasters_bg_col = $cmsmasters_option['theater' . '_bg_col'];

			$cmsmasters_bg_img_enable = $cmsmasters_option['theater' . '_bg_img_enable'];

			$cmsmasters_bg_img_str = $cmsmasters_option['theater' . '_bg_img'];

			$cmsmasters_bg_pos = $cmsmasters_option['theater' . '_bg_pos'];

			$cmsmasters_bg_rep = $cmsmasters_option['theater' . '_bg_rep'];

			$cmsmasters_bg_att = $cmsmasters_option['theater' . '_bg_att'];

			$cmsmasters_bg_size = $cmsmasters_option['theater' . '_bg_size'];
	...
	wp_add_inline_style('theater-style', $out);

}



add_action('wp_enqueue_scripts', 'theater_theme_bg_styles');
...
function theater_logo() {
	...
	if ($cmsmasters_option['theater' . '_logo_type'] == 'text') {

		if ($cmsmasters_option['theater' . '_logo_title'] != '') {

			$blog_title = $cmsmasters_option['theater' . '_logo_title'];

		} else {

			$blog_title = (get_bloginfo('name')) ? get_bloginfo('name') : 'Theater';
		...
		if ($cmsmasters_option['theater' . '_logo_subtitle'] != '') {

			$blog_descr = $cmsmasters_option['theater' . '_logo_subtitle'];

		} else {

			$blog_descr = (get_bloginfo('description')) ? get_bloginfo('description') : esc_html__('Default Logo Subtitle', 'theater');
		...
		echo '<a href="' . esc_url(home_url('/')) . '" title="' . esc_attr($blog_title) . '" class="logo">' . "\n\t" . 
			...
			'<span class="logo_text_wrap">' . 
				...
				($cmsmasters_option['theater' . '_logo_subtitle'] ? '<span class="title_text">' . esc_html($blog_descr) . '</span>' : '') . 
		...
		if ($cmsmasters_option['theater' . '_logo_url'] == '') {
			...
			$logo_img = explode('|', $cmsmasters_option['theater' . '_logo_url']);
			...
			if ($cmsmasters_option['theater' . '_logo_url_retina'] != '') {

				$logo_img_retina = explode('|', $cmsmasters_option['theater' . '_logo_url_retina']);
...
function theater_theme_logo_styles() {
	...
	if ($cmsmasters_option['theater' . '_logo_type'] == 'text') {
		...
		if ($cmsmasters_option['theater' . '_logo_custom_color']) {

			$out .= "

				#header a.logo span.title {

					" . cmsmasters_color_css('color', $cmsmasters_option['theater' . '_logo_title_color']) . "
				...
				#header a.logo span.title_text {
					...
					" . cmsmasters_color_css('color', $cmsmasters_option['theater' . '_logo_subtitle_color']) . "
		...
		$header_mid_height = (($cmsmasters_option['theater' . '_header_mid_height'] !== '') ? $cmsmasters_option['theater' . '_header_mid_height'] : $defaults[$tab]['theater' . '_header_mid_height']);
...
add_action('wp_enqueue_scripts', 'theater_theme_logo_styles');
...
function theater_footer_logo($cmsmasters_option) {
	...
	if ($cmsmasters_option['theater' . '_footer_logo_url'] == '') {
		...
		$footer_logo_img = explode('|', $cmsmasters_option['theater' . '_footer_logo_url']);
		...
		if ($cmsmasters_option['theater' . '_footer_logo_url_retina'] != '') {

			$footer_logo_img_retina = explode('|', $cmsmasters_option['theater' . '_footer_logo_url_retina']);
...
<div class=\"social_wrap\">
	...
	<div class=\"social_wrap_inner\">
		...
		foreach ($cmsmasters_option['theater' . '_social_icons'] as $cmsmasters_social_icons) {
...
function theater_get_comments($class = false, $show = false, $add_html = false) { 
	...
	if ($add_html) {
		...
		$text = (get_comments_number() == '1') ? esc_html__('comment', 'theater') : esc_html__('comments', 'theater');
	...
	if (comments_open()) {
		...
		$out .= '<span class="cmsmasters_comments' . ($class ? ' ' . $class : '') . '">' . 
			...
			'<a class="cmsmasters_theme_icon_comment" href="' . esc_url(get_comments_link()) . '" title="' . esc_attr__('Comment on', 'theater') . ' ' . esc_attr(get_the_title()) . '">' . 
...
function theater_get_the_category_list($cmsmasters_id, $taxonomy, $sep = '', $before = '', $after = '', $taxonomy_class = false) {
...
function theater_theme_page_layout_scheme() {
	...
	} elseif (CMSMASTERS_TRIBE_EVENTS && tribe_is_event_query() && isset($cmsmasters_option['theater' . '_events_layout'])) {

		$cmsmasters_layout = $cmsmasters_option['theater' . '_events_layout'];

	} elseif (is_archive() || is_home()) {

		$cmsmasters_layout = $cmsmasters_option['theater' . '_archives_layout'];

	} elseif (is_search()) {

		$cmsmasters_layout = $cmsmasters_option['theater' . '_search_layout'];

	} else {

		$cmsmasters_layout = $cmsmasters_option['theater' . '_other_layout'];
	...
	if ($cmsmasters_layout == '') {
		...
		$cmsmasters_layout = $cmsmasters_option['theater' . '_layout'];
...
function theater_global_shortcodes_styles_move($content) {
...
function theater_row_checker($data) {

	$out = theater_rowcheck($data);
...
add_filter('the_content', 'theater_row_checker', 10, 2);
		...
		if ($post_ID != '') {
			...
			if (isset($_COOKIE['like-' . $post_ID]) || count($ipCheck) != 0) {
				...
				if ($add_html == 'true') {
					...
					$text = ($plusLike == '1') ? esc_html__('like', 'theater') : esc_html__('likes', 'theater');
...
function cmsmasters_ajax_apply_theme_style_callback() {
	...
	if (wp_verify_nonce($nonce, 'cmsmasters_ajax_apply_theme_style-nonce')) {
		...
		if (isset($_POST['theme_style'])) {
			...
			update_option('cmsmasters_theater_theme_style', $_POST['theme_style']);
...
function theater_theme_style_change() {

	if (get_option('cmsmasters_options_theater' . CMSMASTERS_THEME_STYLE . '_theme_style')) {

		return;

	} else {

		theater_add_global_options();

		

		theater_add_global_icons();
...
add_action('init', 'theater_theme_style_change');
...
function cmsmasters_ajax_reset_settings_callback() {
	...
	if (wp_verify_nonce($nonce, 'cmsmasters_ajax_reset_settings-nonce')) {
		...
		theater_add_global_options(true);
...
function cmsmasters_ajax_export_settings_callback() {
	...
	if (wp_verify_nonce($nonce, 'cmsmasters_ajax_export_settings-nonce')) {
		...
		$cmsmasters_global_settings = array( 
			...
			'cmsmasters_options_' . 'theater' . CMSMASTERS_THEME_STYLE . '_general', 

			'cmsmasters_options_' . 'theater' . CMSMASTERS_THEME_STYLE . '_bg', 

			'cmsmasters_options_' . 'theater' . CMSMASTERS_THEME_STYLE . '_header', 

			'cmsmasters_options_' . 'theater' . CMSMASTERS_THEME_STYLE . '_content', 

			'cmsmasters_options_' . 'theater' . CMSMASTERS_THEME_STYLE . '_footer', 

			'cmsmasters_options_' . 'theater' . CMSMASTERS_THEME_STYLE . '_font_content', 

			'cmsmasters_options_' . 'theater' . CMSMASTERS_THEME_STYLE . '_font_link', 

			'cmsmasters_options_' . 'theater' . CMSMASTERS_THEME_STYLE . '_font_nav', 

			'cmsmasters_options_' . 'theater' . CMSMASTERS_THEME_STYLE . '_font_heading', 

			'cmsmasters_options_' . 'theater' . CMSMASTERS_THEME_STYLE . '_font_other', 

			'cmsmasters_options_' . 'theater' . CMSMASTERS_THEME_STYLE . '_element_sidebar', 

			'cmsmasters_options_' . 'theater' . CMSMASTERS_THEME_STYLE . '_element_icon', 

			'cmsmasters_options_' . 'theater' . CMSMASTERS_THEME_STYLE . '_element_lightbox', 

			'cmsmasters_options_' . 'theater' . CMSMASTERS_THEME_STYLE . '_element_sitemap', 

			'cmsmasters_options_' . 'theater' . CMSMASTERS_THEME_STYLE . '_element_error', 

			'cmsmasters_options_' . 'theater' . CMSMASTERS_THEME_STYLE . '_element_code', 

			'cmsmasters_options_' . 'theater' . CMSMASTERS_THEME_STYLE . '_element_recaptcha', 

			'cmsmasters_options_' . 'theater' . CMSMASTERS_THEME_STYLE . '_single_post', 

			'cmsmasters_options_' . 'theater' . CMSMASTERS_THEME_STYLE . '_single_project', 

			'cmsmasters_options_' . 'theater' . CMSMASTERS_THEME_STYLE . '_single_profile'
		...
		foreach (theater_all_color_schemes_list() as $key => $value) {

			$cmsmasters_global_colors[] = 'cmsmasters_options_' . 'theater' . CMSMASTERS_THEME_STYLE . '_color_' . $key;
...
function theater_optimization_plugins_settings() {

	if(class_exists('farFutureExpiration') && !get_option('theater_register_far_future_settings_enabled')) {
		...
		$options = apply_filters('theater_far_future_settings_filter', $options);
		...
		update_option('theater_register_far_future_settings_enabled', true);

	}

	

	if(class_exists('WpsolMain') && !get_option('theater_wpsol_optimization_settings_enabled')) {
		...
		$options = apply_filters('theater_wpsol_optimization_settings_filter', $options);
		...
		update_option('theater_wpsol_optimization_settings_enabled', true);
...
add_action('admin_enqueue_scripts', 'theater_optimization_plugins_settings');
