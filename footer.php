...
<footer id="footer" class="<?php echo 'cmsmasters_color_scheme_' . $cmsmasters_option['theater' . '_footer_scheme'] . ($cmsmasters_option['theater' . '_footer_type'] == 'default' ? ' cmsmasters_footer_default' : ' cmsmasters_footer_small'); ?>">
