...
<?php theater_get_header_search_form($cmsmasters_option); ?>



<!-- Start Page -->

<div id="page" class="<?php theater_get_page_classes($cmsmasters_option); ?>hfeed site">
...
<header id="header"<?php 
	...
	if ($cmsmasters_option['theater' . '_header_styles'] == 'fullwidth') {
...
new_theater_page_heading();

	

list($cmsmasters_layout, $cmsmasters_page_scheme) = theater_theme_page_layout_scheme();
