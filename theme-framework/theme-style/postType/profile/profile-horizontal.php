...
<article id="post-<?php the_ID(); ?>" <?php post_class('cmsmasters_profile_horizontal ' . $columns_num); ?>>
	...
	if (has_post_thumbnail()) {
		echo '<div class="cmsmasters_profile_img_wrap">';
			...
			theater_profile_social_icons($cmsmasters_profile_social, $profile_id);
			
			theater_thumb_rollover(get_the_ID(), 'cmsmasters-square-thumb', false, true, false, false, false, false, false, false, true);
	...
	echo '<div class="profile_inner">';
		...
		theater_profile_heading(get_the_ID(), 'h4', $cmsmasters_profile_subtitle, 'h6', true, 'horizontal');
		
		theater_profile_exc_cont();
